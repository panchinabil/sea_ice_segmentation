...
from .helpers import initialize_weights, set_trainable
...
class PSPNet(BaseModel):
    def __init__(self, num_classes, in_channels=3, backbone='resnet152', pretrained=True, use_aux=False, freeze_bn=False, freeze_backbone=False, **_):
    ...
    def split_model(self):
        return (
            [
                ...
                [self.master_branch, self.auxiliary_branch],
            ]
        )
